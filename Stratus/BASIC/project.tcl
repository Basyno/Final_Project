...
#
define_hls_module	hash	hash.cc		;# SystemC module to be synthesized
define_hls_config	hash	BASIC		;# A synthesis configuration of the hls_module
define_hls_config   hash    DPA   
#
# Simulation Configurations
#
define_sim_config B			{hash BEH}			;# A behavioral PIN-level configuration
define_sim_config BASIC_V	{hash RTL_V BASIC}	;# RTL Verilog cosimulation
define_sim_config DPA_V	    {hash RTL_V DPA}	;    # RTL Verilog cosimulation

######################################################################
# Genus Logic Synthesis Configuration
######################################################################
define_logic_synthesis_config L {hash -all} \
    -options \
        {BDW_LS_NOGATES 1} \
