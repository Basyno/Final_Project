...
#include "defines.h"
#include "tb.h"
#include "hash_wrap.h"		// use the generated wrapper for all hls_modules
...
SC_MODULE( System )
{
	...
	hash_wrapper	*m_hash;		// use the generated wrapper for the DUT hls module
	tb		*m_tb;
	...
	, chan2( "chan2" )
	{
		...
		m_hash = new hash_wrapper( "dut_wrapper" );
		m_hash->clk( clk_sig );
		m_hash->rst( rst_sig );
		m_hash->din( chan1 );
		m_hash->dout( chan2 );
