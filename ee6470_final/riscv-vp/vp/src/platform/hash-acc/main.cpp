...
public:
	...
	addr_t HASH_start_addr = 0x73000000;
 	addr_t HASH_size = 0x01000000;
 	addr_t HASH_end_addr = HASH_start_addr + HASH_size - 1;
	...
	void parse(int argc, char **argv) override {
		...
		assert((mem_end_addr < clint_start_addr || mem_start_addr > HASH_end_addr) &&
...
int sc_main(int argc, char **argv) {
	...
	bus.ports[12] = new PortMapping(opt.HASH_start_addr, opt.HASH_end_addr);
